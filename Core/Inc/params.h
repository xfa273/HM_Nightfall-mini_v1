...
/*PIDパラメータ*/
#define KP_DISTANCE 15.0F // 並進位置制御のP項
#define KI_DISTANCE 0.0F // 並進位置制御のI項
#define KD_DISTANCE 0.0F // 並進位置制御のD項

#define KP_VELOCITY 20.0F   // 並進速度制御のP項
#define KI_VEROCITY 0.0F // 並進速度制御のI項
#define KD_VEROCITY 0.0F   // 並進速度制御のD項

#define KP_ANGLE 0.0F // 角度制御のP項
#define KI_ANGLE 0.0F // 角度制御のI項
#define KD_ANGLE 0.0F // 角度制御のD項

#define KP_OMEGA 1.3F   // 角速度制御のP項 0.45F
#define KI_OMEGA 0.05F  // 角速度制御のI項 0.015F
#define KD_OMEGA 0.0F   // 角速度制御のD項 0.06F
#define FF_OMEGA 0.02F // 角速度制御のFF項 0.012F
