    ...
    while (1) {
        ...
        case 0: { // 調整モード選択（0..9）
            ...
            case 0: // 通常ターン
                ...
                {
                    const ShortestRunModeParams_t *pm0 = &shortestRunModeParams3;
                    ...
                    drive_fan(0);
                    log_stop();
                    printf("[mode3-case0-sub0] Press RIGHT FRONT for OMEGA (FR>%u), LEFT FRONT for ANGLE (FL>%u) ...\n",
            ...
            case 1: // 90deg大回り
                ...
                {
                    const ShortestRunModeParams_t *pm1 = &shortestRunModeParams3;
                    ...
                    drive_fan(0);
                    log_stop();
                    printf("[mode3-case0-sub1] Press RIGHT FRONT for OMEGA (FR>%u), LEFT FRONT for ANGLE (FL>%u) ...\n",
                           (unsigned)WALL_BASE_FR, (unsigned)WALL_BASE_FL);
                    while (1) {
                        if (ad_fr > WALL_BASE_FR) { log_print_omega_all(); break; }
                        else if (ad_fl > WALL_BASE_FL) { log_print_angle_all(); break; }
            ...
            case 2: // 180deg大回り
                ...
                {
                    const ShortestRunModeParams_t *pm2 = &shortestRunModeParams3;
                    ...
                    drive_fan(0);
                    log_stop();
                    printf("[mode3-case0-sub2] Press RIGHT FRONT for OMEGA (FR>%u), LEFT FRONT for ANGLE (FL>%u) ...\n",
                           (unsigned)WALL_BASE_FR, (unsigned)WALL_BASE_FL);
                    while (1) {
                        if (ad_fr > WALL_BASE_FR) { log_print_omega_all(); break; }
                        else if (ad_fl > WALL_BASE_FL) { log_print_angle_all(); break; }
            ...
            case 3: // 45deg 入り
                ...
                {
                    const ShortestRunModeParams_t *pm3 = &shortestRunModeParams3;
                    ...
                    drive_fan(0);
                    log_stop();
                    printf("[mode3-case0-sub3] Press RIGHT FRONT for OMEGA (FR>%u), LEFT FRONT for ANGLE (FL>%u) ...\n",
                           (unsigned)WALL_BASE_FR, (unsigned)WALL_BASE_FL);
                    while (1) {
                        if (ad_fr > WALL_BASE_FR) { log_print_omega_all(); break; }
                        else if (ad_fl > WALL_BASE_FL) { log_print_angle_all(); break; }
            ...
            case 4: // 45deg 出
                ...
                {
                    const ShortestRunModeParams_t *pm4 = &shortestRunModeParams3;
                    ...
                    drive_fan(0);
                    log_stop();
                    printf("[mode3-case0-sub4] Press RIGHT FRONT for OMEGA (FR>%u), LEFT FRONT for ANGLE (FL>%u) ...\n",
                           (unsigned)WALL_BASE_FR, (unsigned)WALL_BASE_FL);
                    while (1) {
                        if (ad_fr > WALL_BASE_FR) { log_print_omega_all(); break; }
                        else if (ad_fl > WALL_BASE_FL) { log_print_angle_all(); break; }
            ...
            case 5: // V90
                ...
                {
                    const ShortestRunModeParams_t *pm5 = &shortestRunModeParams3;
                    ...
                    drive_fan(0);
                    log_stop();
                    printf("[mode3-case0-sub5] Press RIGHT FRONT for OMEGA (FR>%u), LEFT FRONT for ANGLE (FL>%u) ...\n",
                           (unsigned)WALL_BASE_FR, (unsigned)WALL_BASE_FL);
                    while (1) {
                        if (ad_fr > WALL_BASE_FR) { log_print_omega_all(); break; }
                        else if (ad_fl > WALL_BASE_FL) { log_print_angle_all(); break; }
            ...
            case 6: // 135deg 入り
                ...
                {
                    const ShortestRunModeParams_t *pm6 = &shortestRunModeParams3;
                    ...
                    drive_fan(0);
                    log_stop();
                    printf("[mode3-case0-sub6] Press RIGHT FRONT for OMEGA (FR>%u), LEFT FRONT for ANGLE (FL>%u) ...\n",
                           (unsigned)WALL_BASE_FR, (unsigned)WALL_BASE_FL);
                    while (1) {
                        if (ad_fr > WALL_BASE_FR) { log_print_omega_all(); break; }
                        else if (ad_fl > WALL_BASE_FL) { log_print_angle_all(); break; }
            ...
            case 7: // 135deg 出
                ...
                {
                    const ShortestRunModeParams_t *pm7 = &shortestRunModeParams3;
                    ...
                    drive_fan(0);
                    log_stop();
                    printf("[mode3-case0-sub7] Press RIGHT FRONT for OMEGA (FR>%u), LEFT FRONT for ANGLE (FL>%u) ...\n",
                           (unsigned)WALL_BASE_FR, (unsigned)WALL_BASE_FL);
                    while (1) {
                        if (ad_fr > WALL_BASE_FR) { log_print_omega_all(); break; }
                        else if (ad_fl > WALL_BASE_FL) { log_print_angle_all(); break; }
