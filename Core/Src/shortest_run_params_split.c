...
const ShortestRunModeParams_t shortestRunModeParams3 = {
    ...
    .alpha_turn45in    = 26833.0f,
    .angle_turn45in    = 45.0f,
    .dist_turn45in     = 22.0f,
    // 45deg Out
    .velocity_turn45out= 1000.0f,
    .alpha_turn45out   = 26833.0f,
    .angle_turn45out   = 45.0f,
    .dist_turn45out_in = 19.0f,
    .dist_turn45out_out= 3.0f,
    // V90deg
    .velocity_turnV90  = 1000.0f,
    .alpha_turnV90     = 41008.0f,
    .angle_turnV90     = 90.0f,
    .dist_turnV90_in   = 5.0f,
    .dist_turnV90_out  = 8.0f,
    // 135deg In
    .velocity_turn135in = 1000.0f,
    .alpha_turn135in    = 25870.0f,
    .angle_turn135in    = 135.0f,
    .dist_turn135in_in  = 5.0f,
    .dist_turn135in_out = 0.0f,
    // 135deg Out
    .velocity_turn135out = 1000.0f,
    .alpha_turn135out    = 27126.0f,
    .angle_turn135out    = 135.0f,
    .dist_turn135out_in  = 0.0f,
    .dist_turn135out_out = 11.0f,
    // Fan
    .fan_power          = 600,
    // Makepath
    .makepath_type_case3 = 0,
...
const ShortestRunModeParams_t shortestRunModeParams4 = {
    ...
    // 45deg In
    .velocity_turn45in  = 1000.0f,
    .alpha_turn45in     = 24000.0f,
    .angle_turn45in     = 45.0f,
    .dist_turn45in      = 22.0f,
    // 45deg Out
    .velocity_turn45out = 1000.0f,
    .alpha_turn45out    = 24000.0f,
    .angle_turn45out    = 45.0f,
    .dist_turn45out_in  = 18.0f,
    .dist_turn45out_out = 3.0f,
    // V90deg
    .velocity_turnV90   = 1000.0f,
    .alpha_turnV90      = 36000.0f,
    .angle_turnV90      = 90.0f,
    .dist_turnV90_in    = 6.0f,
    .dist_turnV90_out   = 9.0f,
    // 135deg In
    .velocity_turn135in = 1000.0f,
    .alpha_turn135in    = 25000.0f,
    .angle_turn135in    = 135.0f,
    .dist_turn135in_in  = 6.0f,
    .dist_turn135in_out = 0.0f,
    // 135deg Out
    .velocity_turn135out = 1000.0f,
    .alpha_turn135out    = 26000.0f,
    .angle_turn135out    = 135.0f,
    .dist_turn135out_in  = 0.0f,
    .dist_turn135out_out = 10.0f,
    .fan_power          = 200,
...
const ShortestRunCaseParams_t shortestRunCaseParamsMode4[9] = {
    ...
    {
        .acceleration_straight = 5555.6f, .acceleration_straight_dash = 15000.0f,
        .velocity_straight = 2500.0f, .kp_wall = 0.05f, .kp_diagonal = 0.05f,
        .straight_weight = 2, .diagonal_weight = 2,
